...
@Component({
  selector: 'app-publicacion-hacienda',
  imports: [
    CommonModule,
    MatCardModule,
    MatFormFieldModule,
  ...
  templateUrl: './publicacion-hacienda.component.html',
  styleUrl: './publicacion-hacienda.component.css'
})
export class PublicacionHaciendaComponent {
   publicaciones: any[] = [];
